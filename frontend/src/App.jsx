...
/* ─────────────────────────────────────────────────────
   ...
   Fade + subtle upward slide on every route change
───────────────────────────────────────────────────── */
...
function RouteProgressBar() {
  ...
  useEffect(() => {
    ...
    bar.style.opacity = '1';
    const t1 = setTimeout(() => {
      bar.style.transition = 'width 0.4s cubic-bezier(.22,1,.36,1)';
      bar.style.width = '85%';
    }, 10);
    const t2 = setTimeout(() => {
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: 'none',
        boxShadow: '0 0 10px rgba(196,98,45,0.5)',
      }}
    />
  );
}
...
/* ─────────────────────────────────────────────────────
   Standard layout (Navbar + CartDrawer + Footer)
───────────────────────────────────────────────────── */
        ...
        <CartProvider>
          ...
          <style>{`
            ...
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            /* ── Utility: scroll reveal (used across pages) ── */
            [data-reveal] {
              opacity: 0;
            ...
            /* ── Skeleton loader ── */
            .skeleton {
              background: linear-gradient(90deg, var(--parch) 25%, var(--parch-dk) 50%, var(--parch) 75%);
            ...
            <Routes>
              ...
              <Route path="/checkout" element={
                <ProtectedRoute role="user">
                  <Layout hideFooter><Checkout /></Layout>
                </ProtectedRoute>
              } />
          ...
          {/* Toast notifications — U-Craft branded */}
          <Toaster
            position="top-right"
            toastOptions={{
              duration: 3500,
              style: {
                ...
                background: '#FDFAF5',
                color: '#1A1208',
                boxShadow: '4px 4px 0 rgba(26,18,8,0.08)',
                padding: '12px 16px',
              },
              success: {
                iconTheme: { primary: '#C4622D', secondary: '#FDFAF5' },
              },
              error: {
                iconTheme: { primary: '#1A1208', secondary: '#FDFAF5' },
              },
            }}
          />
